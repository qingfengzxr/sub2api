...
type APIKey struct {
	...
	// Rate limit in USD per fixed 30-day window (0 = unlimited)
	...
	// Used amount in USD for the current fixed 30-day window
	...
	// Start time of the current fixed 30-day rate limit window
