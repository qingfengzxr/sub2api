...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	usageStandardUnitPriceResolver := service.NewUsageStandardUnitPriceResolver(modelPricingResolver, billingService)
	...
	usageHandler := handler.NewUsageHandler(usageService, apiKeyService, usageStandardUnitPriceResolver, opsService, settingService)
