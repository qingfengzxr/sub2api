...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	// 普通用户 DTO：严禁包含管理员字段（例如 account_rate_multiplier、account、upstream_model、upstream_endpoint）。
	...
	return UsageLog{
		...
		BillableInputTokens:                  l.BillableInputTokens,
		BillableOutputTokens:                 l.BillableOutputTokens,
		BillableCacheCreationTokens:          l.BillableCacheCreationTokens,
		BillableCacheReadTokens:              l.BillableCacheReadTokens,
		BillableImageOutputTokens:            l.BillableImageOutputTokens,
		BillableTextInputTokens:              l.BillableTextInputTokens,
		BillableCachedTextInputTokens:        l.BillableCachedTextInputTokens,
		BillableImageInputTokens:             l.BillableImageInputTokens,
		BillableCachedImageInputTokens:       l.BillableCachedImageInputTokens,
		BillingTokenMultiplier:               l.BillingTokenMultiplier,
		...
		StandardInputPricePerMillion:         l.StandardInputPricePerMillion,
		StandardOutputPricePerMillion:        l.StandardOutputPricePerMillion,
		StandardCacheCreationPricePerMillion: l.StandardCacheCreationPricePerMillion,
		StandardCacheReadPricePerMillion:     l.StandardCacheReadPricePerMillion,
		StandardImageOutputPricePerMillion:   l.StandardImageOutputPricePerMillion,
		StandardUnitPrice:                    l.StandardUnitPrice,
