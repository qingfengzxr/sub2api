...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		LongContextPricingEnabled: func() bool {
			if req.LongContextPricingEnabled != nil {
				return *req.LongContextPricingEnabled
			}
			return previousSettings.LongContextPricingEnabled
		}(),
		LongContextPricingThresholdTokens: func() int {
			if req.LongContextPricingThresholdTokens != nil {
				return *req.LongContextPricingThresholdTokens
			}
