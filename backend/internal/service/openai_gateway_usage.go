...
func (s *OpenAIGatewayService) RecordUsage(ctx context.Context, input *OpenAIRecordUsageInput) error {
	...
	cost, err = s.calculateOpenAIRecordUsageCost(ctx, result, apiKey, billingModels, multiplier, imageMultiplier, videoMultiplier, billableUsage, serviceTier)
	if err != nil {
...
func (s *OpenAIGatewayService) calculateOpenAIRecordUsageCost(
	...
	for _, candidate := range billingModels {
		...
		cost, err := s.calculateOpenAIRecordUsageTokenCost(ctx, apiKey, candidate, multiplier, billableUsage, serviceTier)
		if err == nil {
			return cost, nil
		}
		lastErr = err
