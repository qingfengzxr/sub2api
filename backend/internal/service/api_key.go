...
type APIKey struct {
	...
	RateLimit30d   float64    // Rate limit in USD per fixed 30d window (0 = unlimited)
	...
	Usage30d       float64    // Used amount in current fixed 30d window
	Window5hStart  *time.Time // Start of current 5h window
	Window1dStart  *time.Time // Start of current 1d window
	Window7dStart  *time.Time // Start of current 7d window
	Window30dStart *time.Time // Start of current fixed 30d window
}
