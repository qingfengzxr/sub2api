...
func TestConfiguredServiceTierMultiplierAppliesToEveryTokenComponent(t *testing.T) {
	...
	fast := service.computeTokenBreakdown(pricing, tokens, 1, "fast", LongContextPricingPolicy{})
	...
	flex := service.computeTokenBreakdown(pricing, tokens, 1, "flex", LongContextPricingPolicy{})
...
func TestAnthropicFastUsesDefaultMultiplierWithoutCatalogTier(t *testing.T) {
	...
	}, 1, "fast", LongContextPricingPolicy{})
