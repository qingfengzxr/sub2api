...
func TestOpenAIFastBilling_FastMultiplierOverridesEnforcedRatio(t *testing.T) {
	...
	standard := svc.computeTokenBreakdown(pricing, tokens, 1, "", LongContextPricingPolicy{})
	fast := svc.computeTokenBreakdown(pricing, tokens, 1, "fast", LongContextPricingPolicy{})
	priority := svc.computeTokenBreakdown(pricing, tokens, 1, "priority", LongContextPricingPolicy{})
	...
	enforced := svc.computeTokenBreakdown(&withoutOverride, tokens, 1, "fast", LongContextPricingPolicy{})
