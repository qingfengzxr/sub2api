...
const usageLogSelectColumns = "id, user_id, api_key_id, account_id, request_id, model, requested_model, upstream_model, group_id, subscription_id, input_tokens, output_tokens, cache_creation_tokens, cache_read_tokens, cache_creation_5m_tokens, cache_creation_1h_tokens, image_output_tokens, image_output_cost, billable_input_tokens, billable_output_tokens, billable_cache_creation_tokens, billable_cache_read_tokens, billable_image_output_tokens, billable_text_input_tokens, billable_cached_text_input_tokens, billable_image_input_tokens, billable_cached_image_input_tokens, billing_token_multiplier, input_cost, output_cost, cache_creation_cost, cache_read_cost, total_cost, actual_cost, rate_multiplier, account_rate_multiplier, billing_type, request_type, stream, openai_ws_mode, duration_ms, first_token_ms, user_agent, ip_address, image_count, image_size, image_input_size, image_output_size, image_size_source, image_size_breakdown, service_tier, reasoning_effort, inbound_endpoint, upstream_endpoint, cache_ttl_overridden, channel_id, model_mapping_chain, billing_tier, billing_mode, account_stats_cost, created_at"
...
var usageLogInsertArgTypes = [...]string{
	...
	"integer",     // billable_input_tokens
	"integer",     // billable_output_tokens
	"integer",     // billable_cache_creation_tokens
	"integer",     // billable_cache_read_tokens
	"integer",     // billable_image_output_tokens
	"integer",     // billable_text_input_tokens
	"integer",     // billable_cached_text_input_tokens
	"integer",     // billable_image_input_tokens
	"integer",     // billable_cached_image_input_tokens
	"numeric",     // billing_token_multiplier
	"numeric",     // input_cost
	"numeric",     // output_cost
...
func prepareUsageLogInsert(log *service.UsageLog) usageLogInsertPrepared {
	...
	return usageLogInsertPrepared{
		...
		args: []any{
			...
			normalizeUsageLogBillingTokenMultiplier(log.BillingTokenMultiplier),
			log.InputCost,
			log.OutputCost,
...
func normalizeUsageLogBillingTokenMultiplier(value float64) float64 {
	if value <= 0 {
		return 1
	}
	return value
...
func normalizeScannedBillingTokenMultiplier(value sql.NullFloat64) float64 {
	if !value.Valid {
		return 1
	}
	return normalizeUsageLogBillingTokenMultiplier(value.Float64)
}
...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	var (
		...
		billingTokenMultiplier         sql.NullFloat64
		inputCost                      float64
		outputCost                     float64
	...
	if err := scanner.Scan(
		...
		&billableImageOutputTokens,
		&billableTextInputTokens,
		&billableCachedTextInputTokens,
		&billableImageInputTokens,
		&billableCachedImageInputTokens,
	...
	log := &service.UsageLog{
		...
		BillableCacheCreationTokens:    billableCacheCreationTokens,
		BillableCacheReadTokens:        billableCacheReadTokens,
		BillableImageOutputTokens:      billableImageOutputTokens,
		BillableTextInputTokens:        billableTextInputTokens,
		BillableCachedTextInputTokens:  billableCachedTextInputTokens,
		BillableImageInputTokens:       billableImageInputTokens,
		BillableCachedImageInputTokens: billableCachedImageInputTokens,
		BillingTokenMultiplier:         normalizeScannedBillingTokenMultiplier(billingTokenMultiplier),
		InputCost:                      inputCost,
