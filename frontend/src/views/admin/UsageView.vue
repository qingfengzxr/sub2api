  ...
  try {
    ...
    while (true) {
      ...
      const rows = (res.items || []).map((log: AdminUsageLog) => [
        ...
        log.billable_input_tokens ?? 0,
        log.billable_output_tokens ?? 0,
        log.billable_cache_read_tokens ?? 0,
        log.billable_cache_creation_tokens ?? 0,
        log.billable_image_output_tokens ?? 0,
