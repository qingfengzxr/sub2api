export default {
  ...
  keys: {
    ...
    rateLimit1d: '日限额 (USD)',
		...
		rateLimitHint: '设置此密钥在固定时间窗口内的最大消费额。0 = 无限制。',
  ...
  usage: {
    ...
    rawTokenUsage: '真实用量',
    billableTokenUsage: '计费用量',
    billingTokenMultiplier: '倍率快照',
    billableTokenDetails: '账单校验用量',
    billableInputTokens: '计费输入 Token',
    billableOutputTokens: '计费输出 Token',
