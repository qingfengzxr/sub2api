export default {
  ...
  keys: {
    ...
    rateLimit1d: 'Daily Limit (USD)',
		...
		rateLimitHint: 'Set the maximum spending for this key within each fixed time window. 0 = unlimited.',
  ...
  usage: {
    ...
    rawTokenUsage: 'Raw Usage',
    billableTokenUsage: 'Billable Usage',
    billingTokenMultiplier: 'Multiplier Snapshot',
    billableTokenDetails: 'Billing Check Usage',
    billableInputTokens: 'Billable Input Tokens',
    billableOutputTokens: 'Billable Output Tokens',
